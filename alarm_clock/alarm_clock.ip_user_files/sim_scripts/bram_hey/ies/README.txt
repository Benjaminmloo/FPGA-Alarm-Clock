...
#
# Generated by export_simulation on Fri Dec 07 13:53:02 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './bram_hey.sh' script.

./bram_hey.sh -reset_run
...
./bram_hey.sh -noclean_files

For more information on the script, please type './bram_hey.sh -help'.
