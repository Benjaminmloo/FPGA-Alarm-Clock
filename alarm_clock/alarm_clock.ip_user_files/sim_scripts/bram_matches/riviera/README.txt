...
#
# Generated by export_simulation on Fri Dec 07 12:24:48 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './bram_matches.sh' script.

./bram_matches.sh -reset_run
...
./bram_matches.sh -noclean_files

For more information on the script, please type './bram_matches.sh -help'.
