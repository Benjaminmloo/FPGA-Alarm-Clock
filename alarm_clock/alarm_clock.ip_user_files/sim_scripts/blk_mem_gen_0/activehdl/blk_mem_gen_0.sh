...
#
# Generated by Vivado on Fri Dec 07 00:44:52 -0500 2018
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/Documents/xilinx/fpga_alarm_clock/alarm_clock/alarm_clock.cache/compile_simlib/activehdl"
  fi
