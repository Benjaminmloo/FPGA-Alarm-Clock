...
HD_PWD='W:/win/ELEC3500/lab/lab_9/fpga_alarm_clock/alarm_clock/alarm_clock.runs/bram_matches_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_matches.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_matches.tcl
